...
#Credits : Álvaro Justen

from PIL import Image, ImageDraw, ImageFont


class ImageText(object):
    def __init__(self, filename_or_size = "photo-1517816743773-6e0fd518b4a6.jpeg", mode='RGBA', background=(0, 0, 0, 0),
                 encoding='utf8'):
    ...
    def write_text(self, xy, text, font_filename, font_size=11,
        ...
        self.draw.text((x, y), text,spacing=4, font=font, fill=color)
        return text_size
